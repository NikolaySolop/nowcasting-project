#!/usr/bin/env python3
"""Run the live CBR RU_M2 / credit-to-economy ingestion job once."""
...
SOURCE_CODE = "CBR_RU_MONEY_CREDIT"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Check the Bank of Russia credit_m2x workbook and insert new "
            "RU_M2, RU_CREDIT_HOUSEHOLDS and RU_CREDIT_CORPORATES observations."
        )
    )
    parser.add_argument(
        "--config",
