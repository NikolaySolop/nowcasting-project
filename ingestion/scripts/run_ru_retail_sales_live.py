#!/usr/bin/env python3
"""Run the live Rosstat RU_RETAIL_SALES ingestion job once."""
...
SOURCE_CODE = "ROSSTAT_RU_RETAIL_SALES"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Check Rosstat retail trade files and insert new RU_RETAIL_SALES "
            "observations after the latest value already stored in the database."
        )
    )
    parser.add_argument(
        "--config",
