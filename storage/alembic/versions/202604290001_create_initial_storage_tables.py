...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["series_id"],
            ["series.id"],
            name=op.f("fk_raw_observation_series_id_series"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["source_id"],
            ["data_source.id"],
            name=op.f("fk_raw_observation_source_id_data_source"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_raw_observation")),
        sa.UniqueConstraint(
            "series_id",
            "source_id",
            "observed_at",
    ...
    op.create_index(
        op.f("ix_raw_observation_observed_at"),
        "raw_observation",
        ["observed_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_raw_observation_publication_at"),
        "raw_observation",
        ["publication_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_raw_observation_series_id"),
        "raw_observation",
        ["series_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_raw_observation_source_id"),
        "raw_observation",
        ["source_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_raw_observation_vintage_at"),
        "raw_observation",
        ["vintage_at"],
        unique=False,
    )
...
def downgrade() -> None:
    op.drop_index(op.f("ix_raw_observation_vintage_at"), table_name="raw_observation")
    op.drop_index(op.f("ix_raw_observation_source_id"), table_name="raw_observation")
    op.drop_index(op.f("ix_raw_observation_series_id"), table_name="raw_observation")
    op.drop_index(op.f("ix_raw_observation_publication_at"), table_name="raw_observation")
    op.drop_index(op.f("ix_raw_observation_observed_at"), table_name="raw_observation")
